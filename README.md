...
| Product Frameworks | [Jobs-to-be-Done](./skills/jobs-to-be-done/SKILL.md), [Hooked Model](./skills/hooked-model/SKILL.md), [Fogg Behavior Model](./skills/fogg-behavior-model/SKILL.md), [product decisions](./skills/making-product-decisions/SKILL.md), [PRD generation](./skills/prd/SKILL.md), [Ralph PRD format](./skills/ralph/SKILL.md) |
...
| Automation & Testing | [agent-browser](./skills/agent-browser/SKILL.md), [dogfood / QA](./skills/dogfood/SKILL.md) |
| Personal Organization | [PARA method](./skills/para-method/SKILL.md) |
